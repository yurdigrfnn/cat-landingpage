    ...
    <Transition.Root show={sidebarOpen} as={React.Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Dialog.Overlay className="fixed inset-0 bg-slate-500 opacity-25" />
        </Transition.Child>
        <Transition.Child
          as={React.Fragment}
        ...
        >
          <div className="relative flex w-full max-w-xs flex-1 flex-col bg-blue-600 py-4">
            <Transition.Child
              as={React.Fragment}
            ...
            <div className="mt-5 flex flex-grow flex-col overflow-y-auto">
              <nav
                className="flex-1 space-y-1 bg-blue-600 px-4 py-2"
                aria-label="Sidebar"
              ></nav>
            </div>
          </div>
